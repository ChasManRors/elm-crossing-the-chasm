...
var _user$project$Models$Player = F3(
	function (a, b, c) {
...
var _user$project$Models$initialModel = {
	players: {
		ctor: '::',
		_0: A3(_user$project$Models$Player, '1', 'Sam', 1),
		_1: {ctor: '[]'}
	}
};
...
if (typeof _user$project$Players_List$main !== 'undefined') {
    _user$project$Players_List$main(Elm['Players']['List'], 'Players.List', undefined);
}
